...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const teacherNav = useMemo<NavItem[]>(
    () => [
      ...
      { href: "/teacher/course-management", label: pick(language, "My Teaching Courses", "My Teaching Courses"), note: pick(language, "Registrar", "Registrar") },
  ...
  const studentNav = useMemo<NavItem[]>(
    () => [
      ...
      { href: "/student/courses", label: pick(language, "My Courses", "My Courses"), note: pick(language, "Enrolled", "Enrolled") },
  ...
  const adminNav = useMemo<NavItem[]>(
    () => [
      ...
      { href: "/admin/academic", label: pick(language, "Registrar Simulation", "Registrar Simulation"), note: pick(language, "Registrar", "Registrar") },
